...
export const NavDashboard = ({ links }) => {
    ...
    return (
        <div className={darkMode ? 'dark' : ''}>
            <nav className="flex flex-row justify-between p-4 sticky top-0 z-50 w-screen bg-neutral-200 dark:bg-gray-800 
                            lg:flex lg:flex-col lg:bg-neutral-200 lg:dark:bg-gray-800 lg:w-60 lg:h-screen lg:p-3 lg:text-gray-700 lg:dark:text-neutral-400">
